...
class ServiceCorpAPI extends CorpAPI
{
    ...
    /**
     * ServiceCorpAPI constructor.
     *
     * @param null $suite_id
     * @param null $suite_secret
     * @param null $suite_ticket
     * @param null $authCorpId
     * @param null $permanentCode
     */
     ...
     *
     * @param string $temp_auth_code 临时授权码
     *
     * @return mixed
     * @throws HttpError
     * @throws InternalError
     ...
     *
     * @param        $auth_corpid
     * @param string $permanent_code 永久授权码
     *
     * @return mixed
     * @throws HttpError
     * @throws InternalError
